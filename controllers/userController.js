...
export const verify = async (req, res) => {
    try {
        ...
        const token = authHeader.split(" ")[1]; //[Bearer,fhdjhfdjgsf] 
...
export const getUserById = async (req, res) => {
    try {
        const { userId } = req.params; //extrat userId from request params
...
export const updateUser = async (req, res) => {
    try {
        ...
        const loggedInUser = req.user // from isAutthenticated middleware
